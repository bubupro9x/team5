...
package com.upshift.upmap.upmap.ntb;
...
import com.upshift.upmap.upmap.behavior.NavigationTabBarBehavior;
...
public class NavigationTabBar extends View implements ViewPager.OnPageChangeListener {
    ...
    protected final static int DEFAULT_BG_COLOR = Color.parseColor("#ff0099cc");
